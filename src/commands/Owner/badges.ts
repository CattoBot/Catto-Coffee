...
export class BadgesCommand extends Subcommand {
    ...
    public async ChatInputCreate(interaction: Subcommand.ChatInputCommandInteraction) {
        ...
        try {
            ...
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/admin:owner_badge_success`, { emoji: Emojis.SUCCESS }) });
        } catch (error) {
            console.error(error);
    ...
    public async ChatInputList(interaction: Subcommand.ChatInputCommandInteraction) {
        ...
        if (!badges.length) {
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/admin:owner_badge_no_badges`, { emoji: Emojis.ERROR }) });
        }
    ...
    public async ChatInputAssign(interaction: Subcommand.ChatInputCommandInteraction) {
        ...
        try {
            ...
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/admin:owner_badge_assign_success`, { emoji: Emojis.SUCCESS }) });
        } catch (error) {
            console.error(error);
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/error:error`, { emoji: Emojis.ERROR }) });
        }
    ...
    public async ChatInputRemove(interaction: Subcommand.ChatInputCommandInteraction) {
        ...
        try {
            ...
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/admin:owner_badge_remove_success`, { emoji: Emojis.SUCCESS }) });
        } catch (error) {
            console.error(error);
            return interaction.editReply({ content: await resolveKey(interaction, `commands/replies/error:error`, { emoji: Emojis.ERROR }) });
        }
