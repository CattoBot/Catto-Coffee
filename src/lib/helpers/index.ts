...
export default class CoreHelper {
	...
	canvas: {
		...
		drawFormattedRank: (context: CanvasRenderingContext2D, rank: string, x: number, y: number) => void;
		drawUserAvatar: (context: CanvasRenderingContext2D, image: Image, x: number, y: number, size: number) => void;
		drawRoundedImage: (context: CanvasRenderingContext2D, image: Image, x: number, y: number, size: number) => void;
		drawUserData: (context: CanvasRenderingContext2D, username: string, level: string, xp: string, x: number, y: number) => void;
